class Twitter {
    ...
    getNewsFeed(userId) {
        ...
        // Ensure the user has a follows set, create empty set if doesn't exist
        ...
        // This is a side effect but matches Implementation 3's behavior
        ...
        for (const followeeId of this.follows.get(userId)) {
            ...
            if (this.tweetsByUser.has(followeeId)) {
                ...
                maxHeap.push([timestamp, tweetId, followeeId, index - 1], timestamp);
            }
        }
        ...
        while (maxHeap.length > 0 && res.length < 10) {
            ...
            const [timestamp, tweetId, followeeId, nextIndex] = heapNode.val;
            ...
            if (nextIndex >= 0) {
                ...
                maxHeap.push([olderTimestamp, olderTweetId, followeeId, nextIndex - 1], olderTimestamp);
            }
        }
