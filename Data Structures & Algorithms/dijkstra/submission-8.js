...
class Solution {
    ...
    shortestPath(n, edges, src) {
        ...
        // 2. Initialze a Priority Queue
        const minPQ = new CustomMinPriorityQueue(); // val: node, prio: weight
        minPQ.push(src, 0);

        // 3. Distances (visited) hash map
        const distances = {};
        ...
        // 5. Fill out the undreached nodes with -1
        for(let i = 0; i < n; i += 1) {
