class MinHeap {
    ...
    siftDown(idx) {
        ...
        while(currIdx < this.length - 1) {
            ...
            const leftChildVal = leftChildIdx < this.length ?this.data[leftChildIdx] : Infinity;
            // const rightChildVal = this.data[rightChildIdx] === undefined ? Infinity : this.data[rightChildIdx];
            const rightChildVal = rightChildIdx < this.length ? this.data[rightChildIdx] : Infinity;
